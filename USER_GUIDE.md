...
4. **Screen Setup**: Keep the bot image targets, such as `email1.png` and `create_account.png`, in `assets/image_targets` so the automation can find what to click on.